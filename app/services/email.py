...
def digest_to_html(email_digest_response) -> str:
    """Convert digest to minimalist HTML style matching tutorial output"""
    html_parts = []
    greeting_html = markdown.markdown(email_digest_response.introduction.greeting, extensions=["extra", "nl2br"])
    introduction_html = markdown.markdown(email_digest_response.introduction.introduction, extensions=["extra", "nl2br"])
    ...
    for article in email_digest_response.articles:
